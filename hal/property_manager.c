...
#if !(defined(VAUNT) || defined(TATE) || defined(TATE_4R4T) || defined(TATE_4R4T_3G) || defined(TATE_8R) || defined(TATE_1BBRX_3G) )
    #error "You must specify either ( TATE | TATE_4R4T | TATE_4R4T_3G | TATE_8R | TATE_1BBRX_3G ) when compiling this project."
#endif
