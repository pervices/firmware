 ...
 * @return Returns 0 on success and -EINVAL on failure.
 */
 ...
 *
 * @return Returns 0 on success. Returns -errno of the first failed libc function used within.
 */
int mkdir_p(const char* path);

/**
 * Equivalent to mkdir -p for the directory containing the file, and then touch on the file
 * @param path The path of the file to create. Must be less than MAX_PATH_LEN
 *
 * @return Return 0 on success. Returns -errno of the first failed libc function used within.
 */
