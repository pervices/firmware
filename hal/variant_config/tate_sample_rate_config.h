...
// Maximum sample rate the device will output
    ...
    // Maximum value of the AD9176's internal NCO given it's 12GHz sample rate
    // This is the theoretical limit from Nyquist and a wave with a positive frequency will be above it. The practical limit is lower
