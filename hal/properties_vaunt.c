...
#define DEFINE_FPGA()                                                                                                         \
    ...
    DEFINE_FILE_PROP_P("fpga/link/sfpa/pay_len"              , hdlr_fpga_link_sfpa_pay_len,            RW, RX_PAY_LEN, SP, NAC)              \
    ...
    DEFINE_FILE_PROP_P("fpga/link/sfpb/pay_len"              , hdlr_fpga_link_sfpb_pay_len,            RW, RX_PAY_LEN, SP, NAC)              \
