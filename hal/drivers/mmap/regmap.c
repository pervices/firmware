...
static const reg_t reg_table[] = {
	...
	{0x100 + HPS2FPGA_GPR_OFST, "sys10",  0x00000000, "RW"},
	{0x110 + HPS2FPGA_GPR_OFST, "sys11",  0x00000000, "RW"},
	{0x120 + HPS2FPGA_GPR_OFST, "sys12",  0x00000000, "RW"},
	{0x130 + HPS2FPGA_GPR_OFST, "sys13",  0x00000000, "RW"},
