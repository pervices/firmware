...
static const reg_t reg_table[] = {
    ...
    // D Clone.
    {0x3000 + HPS2FPGA_GPR_OFST, "sys64", 0x00000000, "RW"},
    {0x3010 + HPS2FPGA_GPR_OFST, "sys65", 0xffff003f, "RO"},
    {0x3020 + HPS2FPGA_GPR_OFST, "sys66", 0x00000000, "RW"},
    {0x3030 + HPS2FPGA_GPR_OFST, "sys67", 0x00000003, "RW"},
    {0x3040 + HPS2FPGA_GPR_OFST, "sys68", 0x00000000, "RW"},
    {0x3050 + HPS2FPGA_GPR_OFST, "sys69", 0x00000000, "RO"},
    {0x3060 + HPS2FPGA_GPR_OFST, "sys70", 0x00000000, "RO"},
    {0x3070 + HPS2FPGA_GPR_OFST, "sys71", 0x00000000, "RW"},
    {0x3080 + HPS2FPGA_GPR_OFST, "sys72", 0x00000000, "RW"},
    {0x3090 + HPS2FPGA_GPR_OFST, "sys73", 0x00000000, "RW"},
    {0x30a0 + HPS2FPGA_GPR_OFST, "sys74", 0x00000000, "RW"},
    {0x30b0 + HPS2FPGA_GPR_OFST, "sys75", 0x00000000, "RW"},
    {0x30c0 + HPS2FPGA_GPR_OFST, "sys76", 0x00000000, "RW"},
    {0x30d0 + HPS2FPGA_GPR_OFST, "sys77", 0x00000000, "RW"},
    {0x30e0 + HPS2FPGA_GPR_OFST, "sys78", 0x00000000, "RO"},
    {0x30f0 + HPS2FPGA_GPR_OFST, "sys79", 0x00000000, "RO"},
    {0x30f4 + HPS2FPGA_GPR_OFST, "sys80", 0x00000000, "RO"},
    {0x30f8 + HPS2FPGA_GPR_OFST, "sys81", 0x00000000, "RO"},
    {0x30fc + HPS2FPGA_GPR_OFST, "sys82", 0x00000000, "RO"},
    {0x3100 + HPS2FPGA_GPR_OFST, "sys83", 0x00000000, "RO"},
    {0x3104 + HPS2FPGA_GPR_OFST, "sys84", 0x00000000, "RO"},
